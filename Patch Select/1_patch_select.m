...
% Convert data to a 150x100 matrix
matrix_data = reshape(mahr, 100, 150)';
...
% Initialize the result matrix
result_matrix_r = zeros(block_size * block_size, patch_num);
...
for idx = 1:patch_num  % Calculate the row and column indices of the current patch
    ...
    result_matrix_r(:, idx) = temp_result;  
end

result_matrix_r = int16(result_matrix_r);